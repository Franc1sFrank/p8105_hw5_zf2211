...
This is saved R object 0.6455607, 239.0109657, 6.461910910^{-54}, 1, 0.6275625, 0.6631599, 1-sample proportions test with continuity correction, two.sided
...
unsolved_data %>% 
  ...
  labs(title = "Estimates and CIs for each city", x = "Estimated Proportions and CIs", y = "City") +
  theme_bw() +
  theme(plot.title = element_text(hjust = 0.5)) 
```
